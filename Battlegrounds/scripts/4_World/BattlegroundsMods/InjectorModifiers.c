modded class MorphineMdfr: ModifierBase
{
	...
	{
		player.AddHealth( "RightLeg","Health", 1.0);
		player.AddHealth( "RightFoot","Health", 1.0);
		player.AddHealth( "LeftLeg","Health", 1.0);
		player.AddHealth( "LeftFoot","Health", 1.0);
	}
};
